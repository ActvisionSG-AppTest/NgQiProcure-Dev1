        ...
        RouterModule.forChild([
            {
                path: '',
                children: [
                    { path: 'sysStatuses/sysStatuses', component: SysStatusesComponent, data: { permission: 'Pages.Administration.SysStatuses' }  },
                    { path: 'paramSettings/paramSettings', component: ParamSettingsComponent, data: { permission: 'Pages.Administration.ParamSettings' }  },
                    { path: 'sysRefs/sysRefs', component: SysRefsComponent, data: { permission: 'Pages.Administration_Reference.SysRefs' }  },
                    { path: 'referenceTypes/referenceTypes', component: ReferenceTypesComponent, data: { permission: 'Pages.Administration_Reference.ReferenceTypes' }  },
                    { path: 'categories/categories', component: CategoriesComponent, data: { permission: 'Pages.Administration.Categories' }  },
