...
import { CategoriesCustomServiceProxy, CreateOrEditCategoryDto } from '@shared/service-proxies/service-custom-proxies';
...
export class CreateOrEditCategoryModalComponent extends AppComponentBase {
    ...
    constructor(
        injector: Injector,
        private _categoriesServiceProxy: CategoriesCustomServiceProxy
    ) {
        super(injector);
    }
