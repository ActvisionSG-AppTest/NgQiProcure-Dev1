...
(function () {
    var showMessage = function (type, message, title, options) {
        ...
        options.title = title;
        options.type = type;
        options.confirmButtonText = options.confirmButtonText || abp.localization.localize('Ok', 'QiProcureDemo');
    ...
    abp.message.confirm = function (message, title, callback, options) {
        options = options || {};
        options.title = title ? title : abp.localization.localize('AreYouSure', 'QiProcureDemo');
        options.type = 'warning';

        options.confirmButtonText = options.confirmButtonText || abp.localization.localize('Yes', 'QiProcureDemo');
        options.cancelButtonText = options.cancelButtonText || abp.localization.localize('Cancel', 'QiProcureDemo');
