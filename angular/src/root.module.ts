...
import { QiProcureDemoCommonModule } from '@shared/common/common.module';
import { AppSessionService } from '@shared/common/session/app-session.service';
import { AppCustomSessionService } from '@shared/common/session/app-custom-session.service';
...
import { API_BASE_CUSTOM_URL } from './shared/service-proxies/service-custom-proxies';
        ...
        return new Promise<boolean>((resolve, reject) => {
            ...
            AppPreBootstrap.run(appBaseUrl, () => {
                ...
                if (UrlHelper.isInstallUrl(location.href)) {
                    ...
                    let appCustomSessionService: AppCustomSessionService = injector.get(AppCustomSessionService);
                    appCustomSessionService.init().then((result) => {
                        initializeAppCssClasses(injector, result);
                        initializeCookieConsent(injector);
                        registerLocales(resolve, reject, spinnerService);
                    }, (err) => {
...
function initializeLocalForage() {
    localForage.config({
        ...
        description: 'Cached data for QiProcureDemo'
    });
}
...
@NgModule({
    ...
    BrowserModule,
        ...
        AppModule,
        QiProcureDemoCommonModule.forRoot(),
        ServiceProxyModule,
        HttpClientModule,
        RootRoutingModule,
        NgxSpinnerModule
    ...
    providers: [
        ...
        { provide: API_BASE_CUSTOM_URL, useFactory: getRemoteServiceBaseUrl },
        {
