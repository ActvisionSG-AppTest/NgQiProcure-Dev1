...
using QiProcureDemo.Auditing.Exporting;
using QiProcureDemo.Authorization;
using QiProcureDemo.Authorization.Users;
using QiProcureDemo.Dto;
using QiProcureDemo.EntityHistory;
using EntityHistoryHelper = QiProcureDemo.EntityHistory.EntityHistoryHelper;

namespace QiProcureDemo.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : QiProcureDemoAppServiceBase, IAuditLogAppService
    {
