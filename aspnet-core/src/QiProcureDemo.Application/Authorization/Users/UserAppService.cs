...
using QiProcureDemo.Authorization.Permissions;
...
using QiProcureDemo.Authorization.Users.Exporting;
...
namespace QiProcureDemo.Authorization.Users
{
    ...
    public class UserAppService : QiProcureDemoAppServiceBase, IUserAppService
    {
        ...
        private readonly TeamMembersAppService _teamMembersAppService;
        ...
        public async Task<PagedResultDto<UserProfileListDto>> GetUserTeamProfilesByReportingTeamMember(GetUsersTeamInput input)
        {
            var query = GetUsersTeamByReportingTeamMemberQuery(input, input.TeamId, input.isSelected,input.ReportingTeamMemberIdFilter);
            var userCount = await query.CountAsync();
                ...
                if (userProfileListDto.ProfilePictureId != null)
                {
                    ...
                    select new GetTeamMemberForViewDto()
                    {
                        TeamMember = new TeamMemberDto
                        {
                            ...
                            ReportingTeamMemberId = o.ReportingTeamMemberId,
                            RoleOrderNumber = o.SysRefFk.OrderNumber,
                            SelectedTeamRoleName = o.SysRefFk.RefCode
                        },
                    };
                    ...
                    foreach (var teamMember in teamMemberListDtos)
                    {
                        ...
                        userProfileListDto.ReportingTo = teamMember.TeamMember.ReportingTeamMemberId;
                        userProfileListDto.RoleOrderNumber = teamMember.TeamMember.RoleOrderNumber;
                        userProfileListDto.SelectedTeamRoleName = teamMember.TeamMember.SelectedTeamRoleName;
                    }
                };
            }
