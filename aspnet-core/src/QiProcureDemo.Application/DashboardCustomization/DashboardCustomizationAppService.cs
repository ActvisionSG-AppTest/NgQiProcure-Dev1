...
using QiProcureDemo.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace QiProcureDemo.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : QiProcureDemoAppServiceBase, IDashboardCustomizationAppService
    {
