...
using QiProcureDemo.Migrations.Seed.Host;
...
namespace QiProcureDemo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : QiProcureDemoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<QiProcureDemoDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{QiProcureDemoConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{QiProcureDemoConsts.ConnectionStringName}", constring);
        }
