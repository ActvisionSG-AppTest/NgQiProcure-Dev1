...
using QiProcureDemo.MultiTenancy.Payments.Stripe;
using QiProcureDemo.MultiTenancy.Payments.Stripe.Dto;
using Stripe;
using Stripe.Checkout;

namespace QiProcureDemo.MultiTenancy.Payments
{
    public class StripePaymentAppService : QiProcureDemoAppServiceBase, IStripePaymentAppService
    {
            ...
            else
            {
                sessionCreateOptions.LineItems = new List<SessionLineItemOptions>
                {
                    new SessionLineItemOptions
                    {
                        ...
                        Currency = QiProcureDemoConsts.Currency,
