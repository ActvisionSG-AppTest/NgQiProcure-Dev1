...
{
    public class SessionAppService : QiProcureDemoAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    CurrencySign = QiProcureDemoConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = QiProcureDemoConsts.AllowTenantsToChangeEmailSettings,
