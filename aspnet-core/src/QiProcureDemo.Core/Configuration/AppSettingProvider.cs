...
using QiProcureDemo.Authentication;
using QiProcureDemo.DashboardCustomization;
...
namespace QiProcureDemo.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!QiProcureDemoConsts.AllowTenantsToChangeEmailSettings)
            {
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        QiProcureDemoConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetTheme2Settings()
        {
            ...
            return new[]
            {
                ...
                new SettingDefinition(themeName + "." + AppSettings.UiManagement.Header.MinimizeType,
                    ...
                    isVisibleToClients: true, scopes: SettingScopes.All),
                new SettingDefinition(themeName + "." + AppSettings.UiManagement.Header.MenuArrows,
                    GetFromAppSettings(themeName + "." + AppSettings.UiManagement.Header.MenuArrows, "true"),
                    isVisibleToClients: true, scopes: SettingScopes.All),
                new SettingDefinition(themeName + "." + AppSettings.UiManagement.SearchActive,
                    GetFromAppSettings(themeName + "." + AppSettings.UiManagement.SearchActive, "false"),
                    isVisibleToClients: true, scopes: SettingScopes.All)
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    ...
                    QiProcureDemoDashboardCustomizationConsts.Applications.Mvc, mvcDefaultSettingsJson,
                    scopes: SettingScopes.User, isVisibleToClients: true),
                new SettingDefinition(
                    AppSettings.DashboardCustomization.Configuration + "." +
                    QiProcureDemoDashboardCustomizationConsts.Applications.Angular, angularDefaultSettingsJson,
                    scopes: SettingScopes.User, isVisibleToClients: true)
            };
        }
        ...
        public List<Dashboard> GetDefaultMvcDashboardViews()
        {
            ...
            return new List<Dashboard>
            {
                new Dashboard
                {
                    DashboardName = QiProcureDemoDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            Name = QiProcureDemoDashboardCustomizationConsts.DefaultPageName,
                            Widgets = new List<Widget>
                            {
                                new Widget
                                {
                                    WidgetId = QiProcureDemoDashboardCustomizationConsts.Widgets.Tenant
                                ...
                                {
                                    WidgetId =
                                        QiProcureDemoDashboardCustomizationConsts.Widgets.Tenant
                ...
                new Dashboard
                {
                    DashboardName = QiProcureDemoDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            ...
                            Widgets = new List<Widget>
                            {
                                new Widget
                                {
                                    WidgetId = QiProcureDemoDashboardCustomizationConsts.Widgets.Host
                                        .TopStats, // Top Stats
                                    Height = 6,
                                    Width = 12,
                                    PositionX = 0,
                                ...
                                {
                                    WidgetId =
                                        QiProcureDemoDashboardCustomizationConsts.Widgets.Host
