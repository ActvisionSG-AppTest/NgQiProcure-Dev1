...
namespace QiProcureDemo.MultiTenancy.Payments.Stripe
{
    public class StripeGatewayManager : QiProcureDemoServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "QiProcureDemo";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + QiProcureDemoConsts.Currency;
        }
