...
using QiProcureDemo.MultiTenancy.Demo;
...
namespace QiProcureDemo.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(QiProcureDemoConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(QiProcureDemoConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
