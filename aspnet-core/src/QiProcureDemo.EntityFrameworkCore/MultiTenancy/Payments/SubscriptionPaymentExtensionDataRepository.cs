...
using QiProcureDemo.EntityFrameworkCore.Repositories;

namespace QiProcureDemo.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : QiProcureDemoRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<QiProcureDemoDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
