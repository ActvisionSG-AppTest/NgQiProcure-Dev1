...
{
    public class SubscriptionPaymentRepository : QiProcureDemoRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<QiProcureDemoDbContext> dbContextProvider)
