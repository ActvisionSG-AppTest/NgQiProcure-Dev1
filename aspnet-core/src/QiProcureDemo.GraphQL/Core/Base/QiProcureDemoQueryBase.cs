...
namespace QiProcureDemo.Core.Base
{
    public abstract class QiProcureDemoQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected QiProcureDemoQueryBase(string fieldName,
