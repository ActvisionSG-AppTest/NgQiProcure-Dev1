...
using QiProcureDemo.Core.Base;
using QiProcureDemo.Core.Extensions;
using QiProcureDemo.Dto;
using QiProcureDemo.Types;

namespace QiProcureDemo.Queries
{
    public class OrganizationUnitQuery : QiProcureDemoQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
