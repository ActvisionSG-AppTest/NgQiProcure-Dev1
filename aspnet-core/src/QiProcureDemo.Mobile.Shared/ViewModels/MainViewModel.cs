...
using QiProcureDemo.Commands;
using QiProcureDemo.Core.Threading;
using QiProcureDemo.Models.NavigationMenu;
using QiProcureDemo.Services.Navigation;
using QiProcureDemo.ViewModels.Base;
using Plugin.Media;
...
using QiProcureDemo.Controls;
using QiProcureDemo.Dto;
using QiProcureDemo.Extensions;
using QiProcureDemo.Localization;
using QiProcureDemo.UI;
using QiProcureDemo.UI.Assets;
using QiProcureDemo.Views;
using DependencyResolver = QiProcureDemo.Core.Dependency.DependencyResolver;

namespace QiProcureDemo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "QiProcureDemo";
