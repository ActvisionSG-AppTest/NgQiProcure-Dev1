...
using QiProcureDemo.Authentication.TwoFactor.Google;
...
using QiProcureDemo.Web.Models.TokenAuth;
using QiProcureDemo.Authorization.Impersonation;
...
using QiProcureDemo.Net.Sms;
using QiProcureDemo.Notifications;
using QiProcureDemo.Security.Recaptcha;
using QiProcureDemo.Web.Authentication.External;
...
namespace QiProcureDemo.Web.Controllers
{
    ...
    public class TokenAuthController : QiProcureDemoControllerBase
    {
