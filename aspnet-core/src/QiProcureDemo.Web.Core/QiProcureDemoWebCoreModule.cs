...
using QiProcureDemo.Web.Authentication.JwtBearer;
using QiProcureDemo.Web.Authentication.TwoFactor;
using QiProcureDemo.Web.Chat.SignalR;
using QiProcureDemo.Web.Configuration;
using QiProcureDemo.Web.DashboardCustomization;

namespace QiProcureDemo.Web
{
    [DependsOn(
    ...
    public class QiProcureDemoWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public QiProcureDemoWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(QiProcureDemoApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(QiProcureDemoWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(QiProcureDemoWebCoreModule).Assembly);
        }
