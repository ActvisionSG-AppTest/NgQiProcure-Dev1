...
using QiProcureDemo.Web.Startup.ExternalLoginInfoProviders;
...
namespace QiProcureDemo.Web.Startup
{
    ...
    public class QiProcureDemoWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public QiProcureDemoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(QiProcureDemoWebHostModule).GetAssembly());
        }
