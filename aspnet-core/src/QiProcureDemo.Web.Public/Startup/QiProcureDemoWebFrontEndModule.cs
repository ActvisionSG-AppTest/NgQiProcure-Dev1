...
namespace QiProcureDemo.Web.Public.Startup
{
    [DependsOn(
        typeof(QiProcureDemoWebCoreModule)
    )]
    public class QiProcureDemoWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public QiProcureDemoWebFrontEndModule(IWebHostEnvironment env, QiProcureDemoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(QiProcureDemoWebFrontEndModule).GetAssembly());
        }
    }
}
