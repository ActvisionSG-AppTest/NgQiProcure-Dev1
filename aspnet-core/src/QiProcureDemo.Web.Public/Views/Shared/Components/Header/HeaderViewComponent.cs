...
using QiProcureDemo.Web.Public.Startup;
using QiProcureDemo.Web.Session;

namespace QiProcureDemo.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : QiProcureDemoViewComponent
    {
